...
for(let i = 0; i<myArray.length; i++){
    ...
    if (Array.isArray(myArray[i])){
        ...
        //we have an array, so we need to loop through it
...
let orig6 = "Toronto Maple Leafs, Chicago Black Hawis, Detroit Red Wings, Boston Bruins, Montreal Canadiens, New York Rangers";
...
console.log(`Last element is ${orig6Array[orig6Array.length-1]}`);
